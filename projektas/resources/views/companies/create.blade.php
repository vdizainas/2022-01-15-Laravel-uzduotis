          ...
          <form method="POST" action="{{route('companies.store')}}" class="needs-validation" novalidate="">
            <div class="row g-3">
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="company_name" placeholder="" value="" required="" name="company_name">
              ...
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="company_type" placeholder="" value="" required="" name="company_type">
                <div class="invalid-feedback">
              ...
              <div class="col-sm-12">
                ...
                <textarea class="form-control" placeholder="Leave a comment here" id="company_description" style="height: 100px" name="company_description"></textarea>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
